  ...
  return (
    <div className="w-full max-w bg-white shadow-md rounded-xl duration-500 hover:scale-102 hover:shadow-xl relative">
      <div className="relative w-full">
        <img src={pet.imagen} alt={`Foto de ${pet.nombre}`} className="h-80 w-full object-cover rounded-t-xl"/>
      ...
      <div className="px-4 py-3">
        ...
        {showViewMore && (
          <button onClick={handleViewMore} className="bg-pborange hover:bg-pbblue text-white font-semibold py-2 px-6 rounded-full shadow-lg transition block w-fit mx-auto text-center">
            Ver Más
          </button>
        )}
